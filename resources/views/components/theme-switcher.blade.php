...
<div class="focus:outline-none p-1 ">
    <div class="flex items-center min-w-6 mr-2 ">
        @if(config('app.env') == 'local' && $helper_icons)
            ...
            <a
                href="https://bladewindui.com/"
                target="_blank"
                class="px-1 mr-2"
                title="{{ __('Bladewind-UI docs [new tab]') }}"
            >
            <span class="">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-8 w-8 dark:text-white text-purple-800 fill-purple-500 rounded-full inline-block"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                >
                    <path class="fill-primary" fill-rule="evenodd" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path>
                </svg>
            </span>
            </a>
            <a
